...
Object.keys(_regExp).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _regExp[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _regExp[key];
...
var _special = _interopRequireWildcard(require("./special"));
...
var _default = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _normal["default"]), _download["default"]), _regExp["default"]), _special["default"]);
